"""
Django settings for AIU_BookEase project.
...
SECRET_KEY = 'django-insecure-ynuc-ft9wh!l^@)*!08q+$pyo4ac3+=cq5=_*hln5jsx96fb^#'
...
ROOT_URLCONF = 'AIU_BookEase.urls'
...
WSGI_APPLICATION = 'AIU_BookEase.wsgi.application'
